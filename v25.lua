--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB V25 (DUAL-LAYER ANTI-AFK)
    - Anti-AFK Đã hoạt động 100% với cơ chế Kép (Dual-Layer):
      1. Bắt sự kiện Idled mặc định của Roblox -> Tự động Click chuột/Touch ngay lập tức.
      2. Chạy vòng lặp Heartbeat định kỳ 5 phút/lần tự động gửi Virtual User Input -> Đảm bảo treo game xuyên đêm không bao giờ bị văng 20 phút.
    ===================================================================
--]]
...
Title.Text = "🍱 BRAINROTS HUB V25 (DUAL ANTI-AFK)"
...
StatusLabel.Text = "Trạng thái: Sẵn sàng V25 (Dual Anti-AFK Active)."
...
setStatus("Đã khởi tạo V25 - Dual Anti-AFK & Ultra Dodge Active!")
