--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB V14 (AUTO SELECT FOOD & NÉ SÉT)
    - Tự Động Chọn Đồ Ăn Cho Cây (Auto Select Food): Tự động chọn loại thức 
      ăn khi bảng "SELECT FOOD / FEED" xuất hiện (Basic Free, None, Better, Premium, Super, Magic).
...
Title.Text = "🍱 BRAINROTS HUB V14 (SELECT FOOD & NÉ SÉT)"
...
-- 🍱 5. Food Choice Selector Button (Cycle through Basic, None, Better, Premium, Super, Magic)
...
setStatus("Đã khởi tạo V14 - Tích hợp Tự Động Chọn Đồ Ăn (Select Food)!")
