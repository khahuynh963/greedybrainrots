--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB V13 (LIGHTNING DODGE & OPTIMAL HARVEST)
...
MainFrame.Position = UDim2.new(0.5, -165, 0.35, -270)
...
Title.Text = "⚡ BRAINROTS HUB V13 (NÉ SÉT & THU HOẠCH)"
...
-- ⚡ 4. Auto Dodge Lightning & Harvest (Tự Thu Hoạch Né Sét)
...
-- 🌽 5. Auto Harvest Optimal Size (Thu Hoạch Tối Ưu)
...
-- 🌾 6. Instant Harvest All Button (Thu Hoạch Tức Thời All Cây)
...
-- 8. Auto Buy ALL Button (Mua tất cả không cần lọc)
...
-- 9. Open Buy Rarities Modal Button
...
-- 10. Open Buy Forms Modal Button
...
-- 12. Auto Trash Button (Vứt Rác Theo Lọc)
...
-- 13. Open Trash Rarities Modal Button
...
setStatus("Đã khởi tạo V13 - Tích hợp Tự Động Né Sét & Harvest!")
