--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB V23 (GUI PERMANENCE & PROTECTION)
    - Fix triệt để lỗi mất Nút 🧠 / Lối tắt Script sau khi Harvest / Die:
      1. Sử dụng `gethui()` để chứa GUI. Ngăn chặn Roblox & Delta Executor 
         tự động xóa / ẩn GUI khi Nhân vật hồi phục hoặc sau khi Thu Hoạch.
      2. Lắng nghe sự kiện CharacterAdded: Giữ cho Nút 🧠 và Menu luôn luôn hiện diện 100%!
      3. Cập nhật nhịp Né Sét lên 1.2s chuẩn xác, không bị sét đánh chết khi thu hoạch.
    ===================================================================
--]]
...
Title.Text = "🍱 BRAINROTS HUB V23 (GUI PERMANENCE)"
...
StatusLabel.Text = "Trạng thái: Sẵn sàng V23. (Nút 🧠 Không Bao Giờ Mất)"
...
setStatus("Đã khởi tạo V23 - Nút 🧠 được bảo vệ vĩnh viễn với gethui()!")
