--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB V19 (COMPACT & TOUCH DRAGGABLE GUI)
    - Khắc Phục Giao Diện Che Màn Hình:
      1. Giao diện mặc định thu gọn (Visible = false) khi vừa load script -> Không che nhân vật, không cản trở di chuyển!
      2. Nút 🧠 nổi tiện lợi ở góc trái. Bấm 🧠 để Bật/Tắt menu chính bất kỳ lúc nào.
      3. Vị trí Menu được chuyển sang góc trên bên phải (Top-Right) và thu gọn kích thước (300x430px) vừa vặn trên LDPlayer.
      4. Tích hợp bộ kéo thả cảm ứng mượt mà (Touch & Mouse Draggable): Kéo Header hoặc Nút 🧠 di chuyển tự do trên màn hình LDPlayer!
    - Giữ nguyên toàn bộ Động cơ Auto Plant 1 Ô, Né Sét ~1s, Auto Food, Auto Buy, Auto Trash, Anti-Ban chuẩn V18.
    ===================================================================
--]]
...
-- 🧠 Floating Toggle Icon Button (Vị trí gọn ở góc trái)
...
-- Main Hub Frame (Đặt gọn ở góc trên bên phải, ẩn mặc định khi vừa load)
...
MainFrame.Visible = false -- MẶC ĐỊNH ẨN KHI LOAD DỂ KHÔNG BỊ CHE MÀN HÌNH NẠP GAME!
...
Title.Text = "🍱 BRAINROTS HUB V19 (TOUCH DRAGGABLE)"
...
StatusLabel.Text = "Trạng thái: Sẵn sàng. (Bấm nút 🧠 để Bật/Tắt Menu)"
...
-- ═══════════════════════════════════════════════════════════
-- 🌱 AUTO PLANT & LIGHTNING HARVEST ENGINE (0.05s Loop)
-- ═══════════════════════════════════════════════════════════
task.spawn(function()
    while true do
        task.wait(0.05)
...
setStatus("Đã khởi tạo V19 - Giao diện thu gọn & kéo thả mượt mà!")
