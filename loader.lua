--[[
    ===================================================================
    🧠 GREEDY BRAINROTS - ULTIMATE AUTO HUB (V20 FAST LOADER)
    ===================================================================
--]]
pcall(function()
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/khahuynh963/greedybrainrots/main/v20.lua?" .. math.random(1, 999999)))()
